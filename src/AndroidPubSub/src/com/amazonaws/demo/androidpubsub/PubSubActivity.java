...
public class PubSubActivity extends Activity {
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a2iqrd2t4kvrcu.iot.us-west-2.amazonaws.com";
    // Cognito pool ID. For this app, pool needs to be unauthenticated pool with
    // AWS IoT permissions.
    private static final String COGNITO_POOL_ID = "us-west-2:9b51608f-409a-426a-8de0-d5e8c1315af5";
    // Name of the AWS IoT policy to attach to a newly created certificate
    private static final String AWS_IOT_POLICY_NAME = "qa_carvi_android_sdk_test_policy";

    // Region of AWS IoT
    // np-northeast-2
    private static final Regions MY_REGION = Regions.US_WEST_2;
    // Filename of KeyStore file on the filesystem
    private static final String KEYSTORE_NAME = "android_test_keystore";
    // Password for the private key in the KeyStore
    private static final String KEYSTORE_PASSWORD = "carvigogo";
    // Certificate and key aliases in the KeyStore
    private static final String CERTIFICATE_ID = "android_test_name";
